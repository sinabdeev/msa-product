...
> Этот файл содержит правила, гайдлайны и контекст проекта для ИИ-агентов, работающих с кодовой базой **msa-product-receiver**.

---

## 1. Обзор проекта

**msa-product-receiver** — микросервис для управления продуктами, построенный на Spring Boot с использованием Kotlin и PostgreSQL. Сервис предоставляет REST API для CRUD операций над продуктами с поддержкой пакетного создания и параллельной обработки.

| Параметр | Значение |
|----------|----------|
| Имя проекта | `msa-product-receiver` |
| Группа | `ru.example` |
| Версия | `0.0.1` |
| Корневой пакет | `ru.example.product.receiver` |
...
└── src/test/kotlin/ru/example/product/receiver/
...
| Пакеты | lowercase.dot.separated | `ru.example.product.receiver` |
...
| [`MsaProductReceiverApplication.kt`](src/main/kotlin/ru/example/product/receiver/MsaProductReceiverApplication.kt) | Точка входа, `@EnableAsync` |
| [`ProductController.kt`](src/main/kotlin/ru/example/product/receiver/controller/ProductController.kt) | REST API endpoints |
| [`ProductService.kt`](src/main/kotlin/ru/example/product/receiver/service/ProductService.kt) | Интерфейс сервиса |
| [`ProductServiceImpl.kt`](src/main/kotlin/ru/example/product/receiver/service/ProductServiceImpl.kt) | Реализация сервиса |
| [`ProductHandler.kt`](src/main/kotlin/ru/example/product/receiver/service/ProductHandler.kt) | Async обработчик |
| [`ProductRepository.kt`](src/main/kotlin/ru/example/product/receiver/repository/ProductRepository.kt) | Репозиторий |
| [`ProductMapper.kt`](src/main/kotlin/ru/example/product/receiver/mappers/ProductMapper.kt) | Маппинг Entity <-> DTO |
| [`ThreadPoolConfig.kt`](src/main/kotlin/ru/example/product/receiver/config/ThreadPoolConfig.kt) | Конфигурация пула потоков |
| [`JsonbConverters.kt`](src/main/kotlin/ru/example/product/receiver/config/converter/JsonbConverters.kt) | JSONB конвертеры |
| [`GlobalExceptionHandler.kt`](src/main/kotlin/ru/example/product/receiver/controller/exception/GlobalExceptionHandler.kt) | Обработка ошибок |
...
1. Добавить в [`ProductEntity.kt`](src/main/kotlin/ru/example/product/receiver/domain/ProductEntity.kt)
2. Добавить в [`ProductDto.kt`](src/main/kotlin/ru/example/product/receiver/domain/ProductDto.kt)
3. Обновить [`ProductMapper.kt`](src/main/kotlin/ru/example/product/receiver/mappers/ProductMapper.kt)
...
1. Добавить метод в [`ProductController.kt`](src/main/kotlin/ru/example/product/receiver/controller/ProductController.kt)
2. Добавить метод в [`ProductService.kt`](src/main/kotlin/ru/example/product/receiver/service/ProductService.kt)
3. Реализовать в [`ProductServiceImpl.kt`](src/main/kotlin/ru/example/product/receiver/service/ProductServiceImpl.kt)
...
3. Обновить [`ProductEntity.kt`](src/main/kotlin/ru/example/product/receiver/domain/ProductEntity.kt)
4. Обновить [`JdbcConfig.kt`](src/main/kotlin/ru/example/product/receiver/config/JdbcConfig.kt) если нужны конвертеры
