...
MSA Product Data — это микросервис, предоставляющий REST API для управления продуктами (CRUD операции) с поддержкой пакетного создания и параллельной обработки. Сервис разработан с использованием современных практик: асинхронность, валидация, стандартизированные ответы и полная документация OpenAPI.
...
```bash
./gradlew build
java -jar build/libs/msa-product-data-0.0.1.jar
```
