...
object ProductStatusTransitions {
     ...
     */
    val TRANSITION_MAP: Map<ProductStatus, Set<ProductStatus>> =
        mapOf(
            ProductStatus.DRAFT to
                setOf(
                    ProductStatus.PENDING_REVIEW,
                    ProductStatus.ARCHIVED,
                ),
            ProductStatus.PENDING_REVIEW to
                setOf(
                    ProductStatus.REVIEWED,
                    ProductStatus.ARCHIVED,
                    ProductStatus.DRAFT, // опционально, если разрешен возврат в черновик
                ),
            ProductStatus.REVIEWED to
                setOf(
                    ProductStatus.APPROVED,
                    ProductStatus.REJECTED,
                ),
            ProductStatus.APPROVED to
                setOf(
                    ProductStatus.ACTIVE,
                    ProductStatus.ARCHIVED,
                ),
            ProductStatus.REJECTED to
                setOf(
                    ProductStatus.PENDING_REVIEW,
                    ProductStatus.ARCHIVED,
                ),
            ProductStatus.ACTIVE to
                setOf(
                    ProductStatus.PROCESSED,
                    ProductStatus.ARCHIVED,
                ),
            ProductStatus.PROCESSED to
                setOf(
                    ProductStatus.SHIPPED,
                    ProductStatus.ARCHIVED,
                ),
            ProductStatus.SHIPPED to
                setOf(
                    ProductStatus.ARCHIVED,
                ),
            ProductStatus.ARCHIVED to
                setOf(
